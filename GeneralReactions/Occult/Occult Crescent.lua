local tbl = 
{
	
	{
		data = 
		{
			displayPath = "",
			name = "Both Zones",
			uuid = "902bbb2f-5a7e-70f3-a657-d660619dda4a",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "Both Zones",
			name = "Phantom Jobs",
			uuid = "5ee2e098-8b37-7cda-93d6-fd584b3aa74e",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Bard",
			uuid = "0342182c-07c1-7d1c-80f4-74ba47b19f2a",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Bard",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Berserker",
			uuid = "1af1bca8-5d09-91a4-8a75-09d8a73237a0",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Berserker",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Black Mage",
			uuid = "18f4b7b6-d2c9-0aeb-8eae-0775a983efe9",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Black Mage",
			name = "P. BLM",
			throttleTime = 100,
			timeout = 2.75,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Blue Mage",
			uuid = "575a1179-5687-69e9-8975-81daaf82717e",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Blue Mage",
			name = "P. Blue Offense",
			throttleTime = 250,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Cannoneer",
			uuid = "362495be-e5c9-8214-98c4-0856d4bf31bc",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Cannoneer",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Chemist",
			uuid = "98c0667a-af07-35a0-97a6-531f63aca09f",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Chemist",
			name = "P. Chemist Rez",
			throttleTime = 1000,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Dancer",
			uuid = "4f58312a-9cdd-c77f-9fe9-9515aa23b3fd",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Dancer",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Dragoon",
			uuid = "8c8cd954-6c05-5022-9aa3-36a935fad650",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Dragoon",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Geomancer",
			uuid = "ae10ca07-8de2-8bca-bf44-f7dd8913e7a2",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Geomancer",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Gladiator",
			uuid = "fa0bbc17-ca6c-673d-b466-6a0a3cc03b09",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Gladiator",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Knight",
			uuid = "7273df70-3018-2993-99a5-9c4e93bb75fd",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Knight",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Monk",
			uuid = "28b00e8a-8e44-6717-a755-9f1fe642d0d3",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Monk",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Mystic Knight",
			uuid = "331300db-04d0-9073-9fee-dcdbd3630421",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Mystic Knight",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Necromancer",
			uuid = "f000ff04-85cf-e008-87f3-03681a211c58",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Necromancer",
			enabled = false,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Ninja",
			uuid = "203bfd15-958a-1b7e-8cbf-14ba5ca00a58",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Ninja",
			name = "P. Ninja",
			throttleTime = 250,
			timeout = 2.5,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Oracle",
			uuid = "7a5c9c26-601e-ccf5-aa39-22d1405c71d0",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Oracle",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Ranger",
			uuid = "0d7f3a5b-b4be-8aff-9691-9b8529b68b73",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Ranger",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Red Mage",
			uuid = "ebd8fdde-aecd-068c-be4f-a7b566ca955b",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Red Mage",
			name = "P. Red Mage",
			throttleTime = 250,
			timeout = 2.5,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Samurai",
			uuid = "d8084e7e-62ae-1761-a933-811d75fa2a5e",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Samurai",
			name = "P. Sam Iainuki",
			throttleTime = 100,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Summoner",
			uuid = "ef73e902-3a37-0e0e-b387-9b0818673d08",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Summoner",
			name = "P. Summoner",
			throttleTime = 250,
			timeout = 2.5,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Thief",
			uuid = "ea43bdcc-deaf-bf9a-a3da-4263d2d471a0",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Thief",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "Time Mage",
			uuid = "b097c23e-5779-504f-9968-ad97329ff32f",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/Time Mage",
	...
	
	{
		data = 
		{
			displayPath = "Both Zones/Phantom Jobs",
			name = "White Mage",
			uuid = "0bf15464-95bf-b0f7-aa8a-5a95e3ab0a65",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "Both Zones/Phantom Jobs/White Mage",
			name = "P. WHM - Attacks",
			throttleTime = 100,
			timeout = 2.75,
	...
	
	{
		data = 
		{
			displayPath = "Both Zones",
			name = "Misc",
			uuid = "0d6216d1-1845-3cd3-b39f-d39fac0f9bc2",
		},
		objectType = "folder",
	},
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"8585bf26-81c3-8633-a4a7-6fa2ea58a7b5",
								true,
							},
							...
							{
								"c9ca46e2-4935-66f5-a9cb-960c2917bf14",
								true,
							},
						},
						gVar = "ACR_RikuWAR3_CD",
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						conditionType = 4,
						inRangeValue = 30,
						name = "Range: Event Entity <= 30y",
						partyTargetType = "Event Entity",
						uuid = "c9ca46e2-4935-66f5-a9cb-960c2917bf14",
						version = 3,
					},
				},
			},
	...
	
	{
		data = 
		{
			displayPath = "",
			name = "South Horn",
			uuid = "a221f808-ca4f-7c8d-bf2e-1913e6e71812",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "South Horn",
			name = "Critical Encounters",
			uuid = "f50c97bf-4490-9916-8a06-1bde6249ebb0",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "South Horn/Critical Encounters",
			name = "Command Urn",
			uuid = "da05d895-f3b2-2344-b8a1-c23e60eaa5d8",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "South Horn/Critical Encounters/Command Urn",
			eventType = 15,
	...
	
	{
		data = 
		{
			displayPath = "South Horn/Critical Encounters",
			name = "Death Claw",
			uuid = "5e883a0d-55a7-b2d9-8c9d-f4ac3745a384",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "South Horn/Critical Encounters/Death Claw",
			eventType = 18,
	...
	
	{
		data = 
		{
			displayPath = "South Horn/Critical Encounters",
			name = "Mythid Idol",
			uuid = "533f0ba6-07ae-bfac-bdaf-26ea09bde71f",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"a0514b9a-12ef-b014-b53d-1ec0863c3999",
								true,
							},
			...
			conditions = 
			{
				
				{
					data = 
					{
						...
						localmapid = 1252,
						name = "South Horn",
						uuid = "a0514b9a-12ef-b014-b53d-1ec0863c3999",
						version = 3,
					},
					inheritedIndex = 1,
				},
			...
			displayPath = "South Horn/Critical Encounters/Mythid Idol",
			eventType = 18,
	...
	
	{
		data = 
		{
			displayPath = "South Horn/Critical Encounters",
			name = "Neo Garula",
			uuid = "1c733f1f-72f4-f38b-ad8f-2445a0fcd254",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "South Horn/Critical Encounters/Neo Garula",
			eventType = 25,
	...
	
	{
		data = 
		{
			displayPath = "South Horn/Critical Encounters",
			name = "On The Hunt",
			uuid = "05718832-548a-55bd-9c0d-20d19f0769e9",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "South Horn/Critical Encounters/On The Hunt",
			eventType = 25,
	...
	
	{
		data = 
		{
			displayPath = "South Horn/Critical Encounters",
			name = "Repaired Lion",
			uuid = "9a2c7973-c3b1-1f5c-be05-7282310a821c",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "South Horn/Critical Encounters/Repaired Lion",
			eventType = 18,
	...
	
	{
		data = 
		{
			displayPath = "South Horn",
			name = "FATEs",
			uuid = "a84d40e6-b0a0-0545-9eda-d0a4915ce47c",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "",
			name = "North Horn",
			uuid = "30d50754-0041-010a-b218-890c8185aca5",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "North Horn",
			name = "Critical Encounters",
			uuid = "a79a1cb9-ec40-36d6-a00e-f65052c15acc",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "North Horn/Critical Encounters",
			name = "A Beast Unleashed",
			uuid = "afb0fb5b-9f15-51b9-a135-9ff1bc5baeef",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/A Beast Unleashed",
			eventType = 22,
	...
	
	{
		...
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Appalling Behavior",
			uuid = "799b84d6-0ec3-ea95-b1de-631c371b4e06",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/Appalling Behavior",
			eventType = 15,
	...
	
	{
		...
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Cursed Resurgence",
			uuid = "0ce82dff-5c0f-7750-a8c1-a6d232e733b9",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/Cursed Resurgence",
			eventType = 3,
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "data.ljCursedResurgenceCombined = data.ljCursedResurgenceCombined or {}\nlocal state = data.ljCursedResurgenceCombined\n\nstate.unsafeDrawUuids = state.unsafeDrawUuids or {}\nstate.blockedCount = state.blockedCount or 0\n\nlocal param1 = eventArgs.a2\nlocal param2 = eventArgs.a3\n\nif param1 == 1 and param2 == 2 then\n    local directionObject = TensorCore.mGetEntity(eventArgs.entityID)\n\n    if directionObject then\n        local cardinalIndex = math.floor(directionObject.pos.h / (math.pi / 2) + 0.5) % 4\n\n        if not state.unsafeDrawUuids[cardinalIndex] then\n            local unsafeDrawer = TensorCore.getCachedDrawer(\n                0x660000FF,\n                0x990000FF,\n                0xCC0000FF,\n                0xFFFFFFFF,\n                2\n            )\n\n            state.unsafeDrawUuids[cardinalIndex] = unsafeDrawer:addTimedDonutCone(\n                13000,\n                directionObject.pos.x,\n                directionObject.pos.y,\n                directionObject.pos.z,\n                5,\n                math.sqrt(800), -- 20-by-20 center-to-corner distance\n                math.rad(90),\n                directionObject.pos.h,\n                0,\n                false,\n                true\n            )\n\n            state.blockedCount = state.blockedCount + 1\n        end\n\n        if state.blockedCount == 3 and not state.safeDrawUuid then\n            local safeHeading\n\n            for index = 0, 3 do\n                if not state.unsafeDrawUuids[index] then\n                    safeHeading = index * math.pi / 2\n                    break\n                end\n            end\n\n            if safeHeading then\n                local safeDrawer = TensorCore.getCachedDrawer(\n                    0x6600FF00,\n                    0x9900FF00,\n                    0xCC00FF00,\n                    0xFFFFFFFF,\n                    2\n                )\n\n                state.safeDrawUuid = safeDrawer:addTimedDonutCone(\n                    13000,\n                    directionObject.pos.x,\n                    directionObject.pos.y,\n                    directionObject.pos.z,\n                    5,\n                    math.sqrt(800), -- 20-by-20 center-to-corner distance\n                    math.rad(90),\n                    safeHeading,\n                    0,\n                    false,\n                    true\n                )\n            end\n        end\n    end\nelseif param1 == 4 and (param2 == 8 or param2 == 32) then\n    if state.safeDrawUuid then\n        Argus.deleteTimedShape(state.safeDrawUuid)\n        state.safeDrawUuid = nil\n    end\n\n    for cardinalIndex, drawUuid in pairs(state.unsafeDrawUuids) do\n        Argus.deleteTimedShape(drawUuid)\n        state.unsafeDrawUuids[cardinalIndex] = nil\n    end\n\n    state.blockedCount = 0\nend\n\nself.used = true",
						conditions = 
						{
							
							{
								"5064e774-e7c2-8995-9958-b3edc6513fbb",
								true,
							},
							
							{
								"29f06e61-6b0a-4cf8-a22e-d2e640d87cf8",
								true,
							},
						},
						gVar = "ACR_RikuWAR3_CD",
						uuid = "c539f796-b570-e056-afeb-66c5fd828374",
						version = 2.1,
					},
				},
			},
			conditions = 
			{
				
				{
					data = 
					{
						...
						localmapid = 1346,
						name = "North Horn",
						uuid = "5064e774-e7c2-8995-9958-b3edc6513fbb",
						version = 3,
					},
					inheritedIndex = 1,
				},
				
				{
					data = 
					{
						...
						dequeueIfLuaFalse = true,
						eventArgOptionType = 2,
						eventEntityContentID = 2015380,
						name = "Event: Entity ContentID Aetherial Ward",
						uuid = "29f06e61-6b0a-4cf8-a22e-d2e640d87cf8",
						version = 3,
					},
				},
			},
			displayPath = "North Horn/Critical Encounters/Cursed Resurgence",
			eventType = 19,
			name = "[Cursed Resurgence] Aetherial Ward",
			uuid = "a62fab52-fc3e-f835-a33b-d965b3590cb3",
			version = 2,
		},
		inheritedIndex = 126,
	},
	
	{
		data = 
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Dark Artistry",
			uuid = "dad19c5f-0da2-0066-97e8-9061eaabb802",
		},
		objectType = "folder",
	},
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"1ce12024-8463-9a7e-b222-38604bcf3cef",
								true,
							},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						localmapid = 1346,
						name = "North Horn",
						uuid = "1ce12024-8463-9a7e-b222-38604bcf3cef",
						version = 3,
					},
				},
			},
			displayPath = "North Horn/Critical Encounters/Dark Artistry",
			eventType = 22,
	...
	
	{
		...
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Forbidden Folios",
			uuid = "40933c63-7d1f-f3e7-ae4a-5c878aafd372",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/Forbidden Folios",
			eventType = 3,
	...
	
	{
		...
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Lost on the Wind",
			uuid = "29db252f-5c2a-472a-87e8-f854b1d92a3c",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/Lost on the Wind",
			eventType = 4,
	...
	
	{
		data = 
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Quarried Away",
			uuid = "03e50cd3-1873-3db6-9b9c-5b219cff44df",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/Quarried Away",
			eventType = 12,
	...
	
	{
		data = 
		{
			displayPath = "North Horn/Critical Encounters",
			name = "Tiny Terror",
			uuid = "7acd2407-7856-728e-921b-ecb5906fce8a",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Critical Encounters/Tiny Terror",
			eventType = 3,
	...
	
	{
		data = 
		{
			displayPath = "North Horn",
			name = "FATEs",
			uuid = "b2a16695-6f03-7f87-8b89-2e5b654062a0",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			displayPath = "North Horn",
			name = "Weather",
			uuid = "2fa4236b-f612-6924-bd47-51ae2a18a96c",
		},
		objectType = "folder",
	},
	
	{
		data = 
		{
			...
			displayPath = "North Horn/Weather",
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "HusbandoMaxAddons.Resistance.API.ResetSeenScouting()\nself.eventConditionMismatch = true\nself.used = true",
						conditions = 
						{
							
							{
								"169a01cd-731a-0fbf-9608-694c42f1b743",
								true,
							},
							
							{
								"b28514da-6594-33d2-b069-82316728204c",
								true,
							},
							
							{
								"a1ec47ee-d170-5cb4-a2cb-1c04280a0b17",
								true,
							},
							
							{
								"5950a0d5-c6f5-e84c-9639-66323d78d785",
								true,
							},
							
							{
								"6b64ac29-d230-28d4-ba53-a444bc1065d3",
								true,
							},
						},
						gVar = "ACR_RikuWAR3_CD",
						name = "Reset Scotuing",
						uuid = "6412558a-c30c-c37a-b283-6e74ff41aa75",
						version = 2.1,
					},
				},
			},
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "local player = TensorCore.mGetPlayer()\nreturn TensorCore.getDistance2d(player.pos, { h = 0, x = 880, y = 258, z = 880 }) < 25",
						name = "In Spawn Arena",
						uuid = "b28514da-6594-33d2-b069-82316728204c",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return HusbandoMaxAddons.Resistance.API.GetSilver() <= 8999",
						name = "Silver <= 8999",
						uuid = "a1ec47ee-d170-5cb4-a2cb-1c04280a0b17",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return HusbandoMaxAddons.Resistance.API.GetGold() <= 8399",
						name = "Gold <= 8399",
						uuid = "5950a0d5-c6f5-e84c-9639-66323d78d785",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return HusbandoMaxAddons.Resistance.API.GetScoutingCooldown() > 0",
						name = "Scouting Cooldown >= 0",
						uuid = "6b64ac29-d230-28d4-ba53-a444bc1065d3",
						version = 3,
					},
				},
			},
			name = "[Resistance] Reset Scouting",
			throttleTime = 1000,
			uuid = "32db8a31-a1c3-baf5-97e2-c7fb6ffc5c0a",
			version = 2,
		},
	}, 
	inheritedProfiles = 
